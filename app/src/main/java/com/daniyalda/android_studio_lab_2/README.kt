...
*
*           activity android:name="com.daniyalda.android_studio_lab_2.LoginActivity"
            android:exported="true"></activity> were missin in manifests
            inorder for the app to not crash while loading to other page
* */

/** SECOND PROBLEM - MISSING FUNCTIONALITY */
/* TODO -
*        Check the code for missing functionality, and implement them.
*        Start by looking into onClickListener --> MainActivity- DONE DONE
*
*
* */
